...
export default function TopSelling() {
  ...
  useEffect(() => {
    const fetchTopSelling = async () => {
      const query = `*[_type == "product" && isTopSelling == true] | order(_createdAt desc)[0...16]{
  ...
  return (
    <div className="px-[5%] lg:px-[8%] py-12 bg-white">
      ...
      <h2 className="text-2xl Unbounded mb-10">Top Selling Items.</h2>
          ...
          >
            ...
            <div className="relative w-full aspect-square flex items-center justify-center overflow-hidden mb-4">
              ...
              {product.sale && product.sale !== "" && (
                <span
                  className={`absolute off-product top-2 px-2 py-1 right-2 flex 
                    items-center justify-center text-[10px] font-bold text-white 
